...
<div id="dialog-numberDetail-form" style="display: none;">
    <form id="numberDetailForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            <tr>
                <td><label for="trainNumberId">教室</label></td>
                <td>
            ...
            $(".numberDetail-delete").click(function (e) {
                ...
                if (confirm("确定要删除这条教室详情吗?")) {
                    $.ajax({
                        ...
                        success: function (result) {
                            if (result.ret) {
                                showMessage("删除教室详情", "操作成功", true);
                                loadNumberDetailList();
                            } else {
                                showMessage("删除教室详情", result.msg, false);
                            }
                        }
                    });
                }
                ...
                buttons: {
                    "添加": function (e) {
                        ...
                        updateNumberDetail(true, function (data) {
                            ...
                            showMessage("新增教室详情", data.msg, false);
                        })
                    },
                    "添加并继续": function (e) {
                        e.preventDefault();
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.ret) {
                        ...
                        showMessage("获取教室", data.msg, false);
                    }
                }
            })
        };
